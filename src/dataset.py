...
def get_data_loaders_round2(tokenizer, batch_size, val_split=0.15):
  ...
  laptop_rv = ReviewDataset('../data/TRAIN/Train_laptop_reviews.csv', '../data/TRAIN/Train_laptop_labels.csv',
                            tokenizer, type='laptop')
  ...
  makeup_train_loader = DataLoader(makeup_train, batch_size // 2, collate_fn=makeup_rv1.batchify, shuffle=True,
                                   num_workers=5,
                                   drop_last=False)
...
def get_pretrain2_loaders(tokenizer, batch_size, val_split=0.15):
  ...
  makeup_rv2 = ReviewDataset('../data/TRAIN/Train_makeup_reviews.csv', '../data/TRAIN/Train_makeup_labels.csv',
                             tokenizer)
  makeup_rv2_aug = ReviewDataset('../data/TRAIN/Train_makeup_aug_reviews.csv',
                                 '../data/TRAIN/Train_makeup_aug_labels.csv',
                                 tokenizer)
  makeup_rv = ConcatDataset([makeup_rv1, makeup_rv2, makeup_rv2_aug])
  makeup_loader = DataLoader(makeup_rv, batch_size, collate_fn=makeup_rv1.batchify, shuffle=True,
                             num_workers=5,
                             drop_last=False)

  laptop_rv = ReviewDataset('../data/TRAIN/Train_laptop_corpus.csv', '../data/TRAIN/Train_laptop_corpus_labels.csv',
                            tokenizer, 'laptop')
  laptop_val_rv = ReviewDataset('../data/TRAIN/Train_laptop_reviews.csv', '../data/TRAIN/Train_laptop_labels.csv',
                                tokenizer, 'laptop')
